...
| Probe atoms (CLOSED 2026-09-17, drift #150): the zawita-obuvi probe file was wiped with the owner's full documents/ reset — nothing to clean. The GENERAL half stays open: moving a source out of _atomize/ keeps its stale atoms file (no deletion cascade on demotion) | next demotion of an _atomize document | extend reconcile to demotions — owner decision |
