...
def test_save_chat_namespace_traversal(client):
    """Namespace escaping DOCUMENTS_ROOT must be blocked."""
    payload = {
        "content": "test",
        "namespace": "../../../etc",
        "filename": "passwd",
...
def test_save_chat_filename_traversal_handler_level(client):
    """Filename escaping folder must be blocked by handler (400), not just Pydantic."""
    payload = {
        "content": "test",
        "namespace": "personal",
        "filename": "../../../etc/passwd",
    ...
    # Pydantic may return 422; if it slips through, handler must return 400.
