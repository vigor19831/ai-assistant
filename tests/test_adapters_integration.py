...
class TestEmbedders:
    ...
    @pytest.mark.asyncio
    async def test_openai_compatible_retry_recovery(self):
        config = EmbedderConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="test-key",
    ...
    @pytest.mark.asyncio
    async def test_openai_compatible_embedder_shutdown_closes_client(self):
        config = EmbedderConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="key",
        ...
        with respx.mock:
            respx.post(
                ...
                200, json={"data": [{"embedding": [0.1] * 1536}]}
            )
...
class TestLLMs:
    ...
    @pytest.mark.asyncio
    async def test_openai_compatible_complete_with_tool_calls(self):
        config = LLMConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="key",
        ...
        with respx.mock:
            ...
            result = await llm.complete([UserMessage(text="calculate")])
    ...
    @pytest.mark.asyncio
    async def test_openai_compatible_complete_skips_malformed_tool_calls(self):
        config = LLMConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="key",
        ...
        with respx.mock:
            ...
            result = await llm.complete([UserMessage(text="test")])
            assert result.text == "Done"
            assert len(result.tool_calls) == 1
            assert result.tool_calls[0]["id"] == "call_1"

    @pytest.mark.asyncio
    async def test_openai_compatible_complete_skips_unknown_tool_call_types(self):
        config = LLMConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="key",
    ...
    @pytest.mark.asyncio
    async def test_openai_compatible_stream_ignores_tool_call_deltas(self):
        config = LLMConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="key",
    ...
    @pytest.mark.asyncio
    async def test_openai_compatible_shutdown_closes_client(self):
        config = LLMConfig(
            provider="openai_compatible",
            api_base="https://api.test.com/v1",
            api_key="key",
