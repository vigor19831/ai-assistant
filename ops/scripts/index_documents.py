...
import os
DOCUMENTS_ROOT = Path(__file__).parent.parent.parent / "documents"
...
def _load_api_key() -> str | None:
    ...
    # Try config.yaml
    config_paths = [PROJECT_ROOT / "config.yaml"]
...
async def main() -> int:
    ...
    try:
        ...
        print("Start the server first: python ops/scripts/start.py")
        return 1
