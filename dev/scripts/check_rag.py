...
import ai_assistant.adapters.embedder_openai_compatible  # noqa: F401, E402
import ai_assistant.adapters.llm_mock  # noqa: F401, E402
import ai_assistant.adapters.llm_openai_compatible  # noqa: F401, E402
import ai_assistant.adapters.memory_sqlite  # noqa: F401, E402
import ai_assistant.adapters.reranker_api  # noqa: F401, E402
import ai_assistant.adapters.reranker_dummy  # noqa: F401, E402
import ai_assistant.adapters.storage_sqlite  # noqa: F401, E402
import ai_assistant.adapters.tools_calculator  # noqa: F401, E402
...
async def main() -> int:
    ...
    for raw_query, _ in test_queries:
        ...
        status = "RAG ON" if len(count) > 0 else "RAG OFF"
